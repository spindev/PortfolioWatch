          ...
          return (
            ...
            >
              ...
              <p className="text-xs text-gray-500 dark:text-slate-400 mt-0.5">
                Eingesetzt: {formatCurrency(finalInvested, CURRENCY, LOCALE)}
              </p>
              <p className={`text-xs font-medium mt-1 ${positive ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-600 dark:text-red-400'}`}>
